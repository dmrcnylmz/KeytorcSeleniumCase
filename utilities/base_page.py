...
class BasePage(object):
    ...
    def assertEqual (self, element,element2):
        WebDriverWait(self.driver, 100).until(lambda driver: self.driver.find_element(*element))
        assertEqualResult= self.driver.find_element(*element)==self.driver.find_element(element2)
        return assertEqualResult

    def is_not_displayed(self, element):
